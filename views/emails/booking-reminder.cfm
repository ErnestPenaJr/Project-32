...
<body>
    <div class="header">
        ...
        <h1>Upcoming Room Booking Reminder</h1>
    </div>

    <p>Dear #args.user.firstName# #args.user.lastName#,</p>

    <p>This is a reminder about your upcoming room booking:</p>
    ...
    <p>If you need to cancel or modify your booking, please do so at least 24 hours in advance by visiting <a href="#application.config.baseUrl#">#application.config.baseUrl#</a></p>
